                ...
                for bn_where in [3,0,1,2,4]:
                    for ac_last in [0]:
                        for keep_prob in [0,0.2]:
                            ...
                            df_dens_test.to_csv('C:\Deeplearning/model/csv/abbe/'
                            ...
                            df_dens_train.to_csv('C:\Deeplearning/model/csv/abbe/'
                                                 + '_score_train-' + str("%.5f" % round(score_train[0], 5))
                                                 + '_score_test-' + str("%.5f" % round(score_test[0], 5))
                                                 + '_numlayer-' + str(num_layers)
                                                 + '_layersize-' + str(layer_size)
                            ...
                            model.save('C:\Deeplearning/model/ABBE_n/model_ABBE_n'
                            ...
                            print('C:\Deeplearning/model/ABBE_n/model_ABBE_n'
                                           + '_score_train-'+ str("%.5f" % round(score_train[0], 5))
                                           + '_score_test-'+ str("%.5f" % round(score_test[0], 5))
                                           + '_numlayer-' + str(num_layers)
                                           + '_layersize-' + str(layer_size)
